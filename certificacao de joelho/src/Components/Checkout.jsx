...
const CheckIcon = () => (
  <svg className="w-5 h-5 text-[#D00727] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="max-w-md mx-auto relative">
          ...
          <div className="relative z-10 bg-black border border-[#D00727] rounded-xl p-8 shadow-xl space-y-4">
            ...
            {/* Botão de compra */}
            <button className="mt-4 text-white font-bold py-3 px-6 w-full rounded-lg transition duration-300" style={{ backgroundColor: '#D00727' }}>
