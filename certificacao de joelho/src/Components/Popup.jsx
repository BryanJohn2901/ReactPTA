import React from 'react'; // Importa a biblioteca React, que é essencial para a criação de componentes de interface.
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
      ...
      <div className="bg-[#FAF7F2] rounded-2xl shadow-xl p-8 w-full max-w-sm">
        ...
        <div className="flex justify-end">
          ...
          {/* Botão de fechar o popup, com o caractere 'X' estilizado em vermelho. */}
          <button onClick={onClose} className="text-[#D00727] text-lg font-bold">⨉</button>
          {/* Botão para fechar o popup.
              ...
              - text-[#D00727]: Define a cor do texto do botão (o 'X') como um tom de vermelho específico.
        ...
        {/* Título do popup, centralizado e em vermelho. */}
        <h2 className="text-[#D00727] font-semibold text-lg mb-6 text-center">
          {/* Título do formulário dentro do popup.
              - text-[#D00727]: Define a cor do texto do título como o mesmo tom de vermelho.
        ...
        <div className="text-left">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border-0 border-b border-[#D00727] bg-transparent focus:outline-none py-1 placeholder:text-gray-400 text-[#333]"
              ...
              // - border-[#D00727]: Define a cor da borda inferior como vermelho.
        ...
        {/* Botão de envio "Continuar", com fundo vermelho e seta para a direita. */}
        <button className="w-full bg-[#D00727] text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2">
          {/* Botão de chamada para ação (Call to Action - CTA) para prosseguir.
              - w-full: Ocupa 100% da largura disponível.
              - bg-[#D00727]: Fundo vermelho.
