...
import React from "react"; // Importa a biblioteca React, essencial para a construção de componentes de interface.
        ...
        <div className="border border-green-600 rounded-xl p-6 space-y-4 shadow-sm">
          ...
          <ul className="space-y-3 text-base">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Personal Trainers</strong> que evitam prescrever exercícios como remada ou supino por medo da dor articular.
              </span>{" "}
            ...
            <li className="flex items-start gap-2">
              <CheckIcon />
              <span>
                <strong>Profissionais que querem se destacar</strong> com domínio técnico superior e segurança na prescrição.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckIcon />
              <span>
                <strong>Treinadores</strong> que atendem alunos com dor no ombro e sentem insegurança técnica.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckIcon />
              <span>
                <strong>Profissionais que querem ganhar mais</strong> por ter uma certificação reconhecida
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="border border-green-600 rounded-xl p-6 space-y-4 shadow-sm">
          ...
          <ul className="space-y-3 text-base">
            ...
            <li className="flex items-start gap-2">
              <CheckIcon />
              <span>
                Prescrição segura e forte dos exercícios mais importantes para membros superiores.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckIcon />
              <span>
                Correção prática e rápida das compensações biomecânicas, sem depender do fisioterapeuta.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckIcon />
