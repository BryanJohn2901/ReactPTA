        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-sans">
          ...
          <div className="flex items-center gap-4 bg-white p-8 sm:p-10 rounded-2xl shadow-md text-left">
            ...
            <p className="text-gray-800 text-[16px] md:text-[18px]">
              Quer oferecer treinos eficientes e seguros para seus clientes.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white p-8 sm:p-10 rounded-2xl shadow-md text-left">
            ...
            <p className="text-gray-800 text-[16px] md:text-[18px]">
              Precisa entender a síndrome do impacto e saber preveni-la.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white p-8 sm:p-10 rounded-2xl shadow-md text-left">
            ...
            <p className="text-gray-800 text-[16px] md:text-[18px]">
              Busca diferenciar seus resultados como profissional.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 bg-white p-8 sm:p-10 rounded-2xl shadow-md text-left">
            ...
            <p className="text-gray-800 text-[16px] md:text-[18px]">
              Deseja aplicar a ciência do ritmo escapuloumeral nos treinos práticos.
            </p>
          </div>
        </div>
      </div>
