  ...
  return (
    <section className="bg-[#fefcf6] text-black py-16 px-4 text-center">
      ...
      <div className="max-w-[1200px] mx-auto space-y-6">
        ...
        {/* Texto de introdução */}
        <p className="text-lg">
          Você já evitou exercícios como agachamento, levantamento terra ou stiff por medo de agravar a dor lombar do seu aluno?
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-black text-white rounded-xl p-6 flex items-start gap-3">
            ...
            <p>
              Medo de agravar hérnias, protusões ou lombalgias;
            </p>
          </div>
          ...
          <div className="bg-black text-white rounded-xl p-6 flex items-start gap-3">
            <CheckCircle className="text-green-600 w-6 h-6 mt-1" />
            <p>
              Insegurança sobre alinhamento pélvico e postura correta;
            </p>
          </div>
