...
const Garantia = () => {
  ...
  return (
    ...
    <section className="bg-black text-white py-20 px-6">
      {" "}
      {/* Define uma seção HTML que serve como o container principal para a garantia.
      ...
      <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 items-center gap-10">
        {" "}
        {/* Define uma div que serve como container interno para o conteúdo da garantia.
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <h3 className="text-green-500 text-lg font-semibold">
            ...
            {/* Título da seção de garantia.
                - text-green-500: Define a cor do texto como um tom de verde.
          ...
          <p className="text-sm md:text-base text-gray-300 leading-relaxed">
            ...
            {/* Parágrafo com a descrição detalhada da garantia.
                - text-sm md:text-base: Define o tamanho da fonte (pequeno em telas menores, base em telas médias e maiores), para boa legibilidade.
          ...
          <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition duration-300">
            ...
            {/* Botão de chamada para ação (Call to Action - CTA).
                ...
                - hover:bg-green-700: Altera a cor de fundo para um tom mais escuro de verde ao passar o mouse, indicando interatividade.
                ...
                - transition duration-300: Adiciona uma transição suave de 300 milissegundos para as mudanças de estilo (como a cor de fundo no hover), melhorando a experiência do usuário. */}
...
export default Garantia; // Exporta o componente Garantia para que ele possa ser importado e utilizado em outras partes da aplicação React.